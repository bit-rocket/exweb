layui.use(['form','layer','table','laytpl'],function(){
    ...
    var tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'orderId', title: 'id', align:"center", width:80},
            ...
            {field: 'earnRate', title: 'earn', align:'center', width:130, templet: function(d) {
                return "" + d.earnAmount + "/" + d.earnRate;
            }},
            ...
            {title: 'op', templet:'#userListBar',fixed:"right",align:"center", minWidth:170}
        ]]
    });
